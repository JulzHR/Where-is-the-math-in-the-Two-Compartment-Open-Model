...
**Note:** The plot in the logarithm scale is used with the "method of residuals" to actually find, true PK parameters such as half-life ($t_{1/2}), apparent volume of distribution ($V_d$), or systemic clearance ($CL$)
